...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="relative bg-black py-32 px-6 md:px-12 overflow-hidden border-t border-[#1A1A1A]">
            ...
            >
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="mt-8 flex items-center gap-4">
                  ...
                  <span className="text-[#F5A623] font-mono text-[10px] tracking-[0.2em] uppercase">
          ...
          <div className="relative w-full max-w-6xl max-h-[90vh] bg-[#0B0B0B] border border-[#1A1A1A] rounded-sm overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="overflow-y-auto p-6 md:p-10 space-y-12 custom-scrollbar">
              ...
              <div className="max-w-3xl">
                <span className="text-[#F5A623] font-mono text-[10px] tracking-[0.3em] uppercase mb-4 block">
                  About the Build
                </span>
              ...
              <div className="space-y-8">
                <span className="text-[#F5A623] font-mono text-[10px] tracking-[0.3em] uppercase block">
                  Project Media
                </span>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {selectedProject.media.map((item, idx) => (
                    <div
                      key={idx}
                      className="group relative aspect-video bg-black rounded-sm overflow-hidden border border-[#1A1A1A]"
                    >
                      {item.type === "image" ? (
                        <Image
                          src={item.url}
