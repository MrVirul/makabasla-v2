      ...
      <div className="max-w-[1240px] mx-auto p-12">
        ...
        <div className="mb-12 flex flex-col items-start gap-8 md:flex-row md:items-end justify-between border-b border-[#1A1A1A] pb-8">
          ...
          <div className="relative w-full md:w-80 group">
            ...
            <input
              ...
              className="w-full bg-[#1A1A1A]/30 text-[#D1D0C5] pl-12 pr-4 py-3 rounded-sm border-transparent outline-none placeholder:text-[#A1A1A1] focus:bg-[#1A1A1A]/50 focus:ring-1 focus:ring-[#F5A623]/30 transition-all font-mono text-xs"
              value={searchTerm}
        ...
        {loading ? (
          ...
          <div className="space-y-px">
            <div className="grid grid-cols-[1fr_2fr_1.5fr_80px] gap-4 px-8 py-4 font-mono text-[10px] text-[#A1A1A1] uppercase tracking-widest border-b border-[#1A1A1A]">
              <span>Name</span>
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="p-2 text-[#1A1A1A] group-hover:text-[#A1A1A1] hover:!text-[#F5A623] transition-colors"
                      title="View Profile"
                    >
